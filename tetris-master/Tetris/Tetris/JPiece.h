...
/// <summary> This class manage the behavior of J piece. </summary>
class JPiece : public Piece
{
public:
	/// <summary> Constructor of JPiece </summary>
	...
	JPiece(const int a_x, const int a_y, const int a_IDColor, const int a_Size);
	...
	/// <param name="a_IDColor"> const int : This is the id that will tell what color to put on the piece. </param>
	/// <param name="a_Size"> const int : This is the size of the piece.  </param>
	JPiece(const int a_x, const int a_y, int a_GridPosX, int a_GridPosY, const int a_IDColor, const int a_Size);

	/// <summary> Destructor of JPiece </summary>
	~JPiece();
	...
	void SetPosition(const int a_x, const int a_y, int GridPosX, int GridPosY) override;
