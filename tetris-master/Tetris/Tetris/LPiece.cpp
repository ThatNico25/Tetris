...
LPiece::LPiece(const int a_x, const int a_y, const int a_IDColor, const int a_Size) :
	m_IDColor(a_IDColor),
	m_Size(a_Size)
{
...
LPiece::LPiece(const int a_x, const int a_y, int a_GridPosX, int a_GridPosY, const int a_IDColor, const int a_Size) :
...
void LPiece::CreatePiece(const int a_x, const int a_y, int a_GridPosX, int a_GridPosY)
{
	if (m_IDColor == 0)
	{
...
void LPiece::SetPosition(const int a_x, const int a_y, int GridPosX, int GridPosY)
{
...
void LPiece::Draw(SDL_Surface* a_ScreenSurface)
{
...
void LPiece::Rotate(int a_angle, int a_OffsetX, int a_OffsetY)
{
	m_Angle = a_angle;
	...
	{
	case 0:
		m_Tiles[0]->SetGridPosition(m_Tiles[0]->GetGridPosX() + 2 + a_OffsetX, m_Tiles[0]->GetGridPosY());
	...
	case 90:
		m_Tiles[0]->SetGridPosition(m_Tiles[0]->GetGridPosX(), m_Tiles[0]->GetGridPosY() + 2 + a_OffsetY);
...
vector<Tiles*> LPiece::GetTiles()
{
	return m_Tiles;
}

int LPiece::GetCollisionSize()
{
	return m_Size;
}
