...
/// <summary> This class manage the behavior of Z piece. </summary>
class ZPiece : public Piece
{
public:
	/// <summary> Constructor of ZPiece </summary>
	...
	ZPiece(const int a_x, const int a_y, const int a_IDColor, const int a_Size);
	...
	/// <param name="a_IDColor"> const int : This is the id that will tell what color to put on the piece. </param>
	/// <param name="a_Size"> const int : This is the size of the piece.  </param>
	ZPiece(const int a_x, const int a_y, int a_GridPosX, int a_GridPosY, const int a_IDColor, const int a_Size);

	/// <summary> Destructor of ZPiece </summary>
	~ZPiece();
